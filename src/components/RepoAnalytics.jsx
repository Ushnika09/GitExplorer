...
function RepoAnalytics() {
  return (
    <div className='grid-cols-1 grid items-center md:grid-cols-2 lg:grid-cols-4 justify-between py-5 gap-10 flex-wrap'>
        ...
        <h1 className='text-gray-600/90 text-sm text-nowrap'>Most:Python</h1>
        </div>
        ...
        <h1 className='text-gray-600/90 text-sm text-nowrap'>Avg 25 per repo</h1>
        </div>
        ...
        <h1 className='text-4xl font-bold'>30</h1>
        <h1 className='text-gray-600/90 text-sm text-nowrap'>Active development</h1>
        </div>
