  ...
  return (
    <div className="flex flex-col justify-center my-7 mx-5 ">
      ...
      <div className=" bg-white rounded-2xl p-3.5 py-6 shadow flex flex-col gap-3 justify-center items-center">
        ...
        <h1 className="text-xl text-gray-500 my-1.5">Start exploring repositories and bookmark your favorites to see them here.</h1>
        <Link to={"/"} className={`flex gap-1 font-bold py-2.5 px-5 md:px-10 rounded-2xl justify-center items-center repo bg-purple-500 text-white hover:bg-purple-500/70`} >Explore Repositories</Link>
      </div> : <Bookmarkdetails />}
    </div>
  );
}
